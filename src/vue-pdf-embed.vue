...
<script setup>
import { computed, defineEmits, defineExpose, defineProps, onBeforeUnmount, onMounted, ref, watch } from 'vue';
...
import { addPrintStyles, createPrintIframe, emptyElement, releaseChildCanvases } from './util.js';
